            ...
            (curp,apellido_paterno,apellido_materno,nombres,sexo,fecha_nacimiento,edad,grado,nivel,apellido_paternotutor,apellido_maternotutor,nombre_tutor,domicilio,telefono_fijo,telefono_emergencia)
                VALUES
                ...
                $sentencia->bindParam(":Grado",$datos["grado"], PDO::PARAM_STR);
                $sentencia->bindParam(":Nivel",$datos["nivel"], PDO::PARAM_STR);
            ...
            public static function editarAlumnosMdl($id)
            {
            ...
            public static function eliminarAlumnosMdl($id)
            {
